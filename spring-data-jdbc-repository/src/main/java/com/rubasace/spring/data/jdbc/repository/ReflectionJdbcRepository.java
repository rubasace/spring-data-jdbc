...
import com.rubasace.spring.data.jdbc.repository.strategy.crud.AbstractRepositoryStrategy;
import com.rubasace.spring.data.jdbc.repository.strategy.crud.RepositoryStrategyFactory;
import com.rubasace.spring.data.jdbc.repository.strategy.id.IdToArrayStrategy;
import com.rubasace.spring.data.jdbc.repository.strategy.id.IdToArrayStrategyFactory;
