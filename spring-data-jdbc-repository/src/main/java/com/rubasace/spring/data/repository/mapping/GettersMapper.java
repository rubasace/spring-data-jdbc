...
public class GettersMapper {

    private GettersMapper() {

    }

    public static Map<String, Method> createGettersMap(Class<?> beanClass) {
        ...
        for (Field field : beanClass.getDeclaredFields()) {
            ...
            Method getter = ReflectionMethodsUtils.findGetterMethod(field, beanClass);
            methodsMap.put(columnName, getter);
        }
        return methodsMap;
    }
}
