...
import com.notech.oneapp.common.rest.common.util.persistence.mapping.ReflectionRowMapper;
import com.notech.oneapp.common.rest.common.util.persistence.mapping.ReflectionRowUnmapper;
import com.notech.oneapp.common.rest.common.util.persistence.util.EntityUtils;
import com.notech.oneapp.common.rest.common.util.persistence.util.GeneratedValueUtil;
import com.notech.oneapp.common.rest.common.util.persistence.util.ReflectionMethodsUtils;
import cz.jirutka.spring.data.jdbc.BaseJdbcRepository;
import cz.jirutka.spring.data.jdbc.UnsupportedRowUnmapper;
...
public class BaseReflectionJdbcRepository<T, ID extends Serializable> extends BaseJdbcRepository<T, ID> {
    ...
    public <S extends T> S save(S entity) {
        if (!(entity instanceof JdbcEntity)) {
            entity = (S) ProxyUtils.getProxiedEntity(entity);
        }
