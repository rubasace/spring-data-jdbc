...
import com.notech.oneapp.common.rest.common.util.persistence.repository.query.lookup.JdbcByNameRepositoryQuery.Strategy;
import com.notech.oneapp.common.rest.common.util.persistence.repository.query.lookup.ParameterProperties.SpecialLike;
...
import com.notech.oneapp.common.rest.common.util.persistence.util.SQLJavaNamingUtils;
        ...
        public String build() {
            ...
            switch (type) {
                ...
                case NOT_IN:
                    ...
                    break;
                case STARTING_WITH:
                    props.setSpecialLike(SpecialLike.STARTS_WITH);
                    query = builder.like(attribute, false);
                    break;
                case ENDING_WITH:
                    props.setSpecialLike(SpecialLike.ENDS_WITH);
                    query = builder.like(attribute, false);
                    break;
                case CONTAINING:
                    props.setSpecialLike(SpecialLike.CONTAINS);
                    query = builder.like(attribute, false);
                    break;
                case NOT_CONTAINING:
                    props.setSpecialLike(SpecialLike.CONTAINS);
